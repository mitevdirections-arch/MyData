...
ROUTE_PLANE_OWNERSHIP: dict[tuple[str, str], str] = {
    ...
    ("DELETE", "/profile/admin/roles/{role_code}"): ROUTE_PLANE_FOUNDATION,
    ...
    ("DELETE", "/users/admin/roles/{role_code}"): ROUTE_PLANE_FOUNDATION,
    ...
    ("POST", "/admin/onboarding/applications/{application_id}/approve"): ROUTE_PLANE_FOUNDATION,
    ...
    ("GET", "/admin/entity-verification/targets/{target_id}"): ROUTE_PLANE_FOUNDATION,
    ("GET", "/admin/entity-verification/targets/{target_id}/summary"): ROUTE_PLANE_FOUNDATION,
    ("GET", "/admin/entity-verification/targets/{target_id}/checks"): ROUTE_PLANE_FOUNDATION,
    ...
    ("GET", "/guard/device/status"): ROUTE_PLANE_FOUNDATION,
    ...
    ("GET", "/partners"): ROUTE_PLANE_OPERATIONAL,
    ("GET", "/partners/{partner_id}"): ROUTE_PLANE_OPERATIONAL,
    ("GET", "/partners/{partner_id}/global-signal"): ROUTE_PLANE_OPERATIONAL,
    ("GET", "/partners/{partner_id}/rating-summary"): ROUTE_PLANE_OPERATIONAL,
    ("GET", "/admin/partners/{partner_id}/verification-summary"): ROUTE_PLANE_OPERATIONAL,
    ("GET", "/admin/company/verification-summary"): ROUTE_PLANE_FOUNDATION,
    ...
    ("POST", "/admin/entity-verification/targets/upsert"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/admin/entity-verification/targets/{target_id}/recheck"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/admin/entity-verification/targets/{target_id}/providers/vies/check"): ROUTE_PLANE_FOUNDATION,
    ...
    ("POST", "/ai/tenant-copilot/order-feedback"): ROUTE_PLANE_OPERATIONAL,
    ...
    ("POST", "/guard/device/activate"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/guard/device/logout"): ROUTE_PLANE_FOUNDATION,
    ...
    ("POST", "/partners"): ROUTE_PLANE_OPERATIONAL,
    ("POST", "/partners/{partner_id}/archive"): ROUTE_PLANE_OPERATIONAL,
    ("POST", "/partners/{partner_id}/blacklist"): ROUTE_PLANE_OPERATIONAL,
    ("POST", "/partners/{partner_id}/ratings"): ROUTE_PLANE_OPERATIONAL,
    ("POST", "/admin/partners/{partner_id}/verification/recheck"): ROUTE_PLANE_OPERATIONAL,
    ("POST", "/admin/company/verification/recheck"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/partners/{partner_id}/watchlist"): ROUTE_PLANE_OPERATIONAL,
    ...
    ("POST", "/profile/admin/users/{user_id}/credentials/invite"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/profile/admin/users/{user_id}/credentials/lock"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/profile/admin/users/{user_id}/credentials/reset-password"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/profile/admin/users/{user_id}/credentials/revoke-invite"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/profile/admin/users/{user_id}/credentials/unlock"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/profile/me/credentials/change-password"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/profile/me/credentials/change-username"): ROUTE_PLANE_FOUNDATION,
    ...
    ("POST", "/profile/admin/users/{user_id}/provision"): ROUTE_PLANE_FOUNDATION,
    ...
    ("POST", "/users/admin/users/{user_id}/credentials/invite"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/users/admin/users/{user_id}/credentials/lock"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/users/admin/users/{user_id}/credentials/reset-password"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/users/admin/users/{user_id}/credentials/revoke-invite"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/users/admin/users/{user_id}/credentials/unlock"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/users/me/credentials/change-password"): ROUTE_PLANE_FOUNDATION,
    ("POST", "/users/me/credentials/change-username"): ROUTE_PLANE_FOUNDATION,
    ...
    ("POST", "/users/admin/users/{user_id}/provision"): ROUTE_PLANE_FOUNDATION,
    ...
    ("PUT", "/partners/{partner_id}"): ROUTE_PLANE_OPERATIONAL,
    ("PUT", "/partners/{partner_id}/roles"): ROUTE_PLANE_OPERATIONAL,
