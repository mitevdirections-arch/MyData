...
ROUTE_POLICY: dict[tuple[str, str], RoutePolicy] = {
    ...
    ("POST", "/profile/me/credentials/change-password"): RoutePolicy("PROFILE.WRITE", authz_mode=AUTHZ_MODE_TOKEN_CLAIMS),
    ("POST", "/profile/me/credentials/change-username"): RoutePolicy("PROFILE.WRITE", authz_mode=AUTHZ_MODE_TOKEN_CLAIMS),
    ...
    ("POST", "/users/me/credentials/change-password"): RoutePolicy("PROFILE.WRITE", authz_mode=AUTHZ_MODE_TOKEN_CLAIMS),
    ("POST", "/users/me/credentials/change-username"): RoutePolicy("PROFILE.WRITE", authz_mode=AUTHZ_MODE_TOKEN_CLAIMS),
