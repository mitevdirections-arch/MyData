...
PERMISSION_REGISTRY: list[dict[str, Any]] = [
    ...
    {"permission_code": "ENTITY_VERIFICATION.READ", "workspace_type": "TENANT", "module_code": "ENTITY_VERIFICATION", "description": "Read verification targets and summaries", "risk_level": "LOW", "sensitive": False, "active": True},
    {"permission_code": "ENTITY_VERIFICATION.CHECK", "workspace_type": "TENANT", "module_code": "ENTITY_VERIFICATION", "description": "Execute provider-specific verification checks", "risk_level": "MEDIUM", "sensitive": True, "active": True},
    {"permission_code": "ENTITY_VERIFICATION.RECHECK", "workspace_type": "TENANT", "module_code": "ENTITY_VERIFICATION", "description": "Trigger manual verification rechecks", "risk_level": "MEDIUM", "sensitive": True, "active": True},
    {"permission_code": "ENTITY_VERIFICATION.READ_EVIDENCE", "workspace_type": "TENANT", "module_code": "ENTITY_VERIFICATION", "description": "Read verification evidence payloads", "risk_level": "HIGH", "sensitive": True, "active": True},
    {"permission_code": "ENTITY_VERIFICATION.ADMIN", "workspace_type": "TENANT", "module_code": "ENTITY_VERIFICATION", "description": "Administer verification targets and contracts", "risk_level": "HIGH", "sensitive": True, "active": True},
